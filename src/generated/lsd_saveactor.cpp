...
LCF_STRUCT_FIELDS_BEGIN()
	...
	LCF_STRUCT_TYPED_FIELD(LcfVector<int16_t>, skills),
	LCF_STRUCT_TYPED_FIELD(LcfVector<int16_t>, equipped),
	LCF_STRUCT_TYPED_FIELD(int, current_hp),
	LCF_STRUCT_TYPED_FIELD(int, current_sp),
	LCF_STRUCT_TYPED_FIELD(LcfVector<uint32_t>, battle_commands),
	LCF_STRUCT_TYPED_FIELD(int, status_size),
	LCF_STRUCT_TYPED_FIELD(LcfVector<int16_t>, status),
